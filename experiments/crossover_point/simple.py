...
def main():
    ...
    while True:
        ...
        print(f"Length: {polyline_length}, DijkstraPrims: {t_dp:.4f}s, BBMS_inter: {t_inter:.4f}s, BBMS_dpp_instant: {t_dpp:.4f}s")

        with open(CSV_PATH, "a") as f:
            f.write(f"{polyline_length},{t_dp:.4f},{t_inter:.4f},{t_dpp:.4f}\n")
