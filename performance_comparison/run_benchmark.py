...
def main():
    ...
    # Run the comparison
    run_benchmark("performance_comparison/test_data/" + filename, algorithm)


def usage():
    print("Usage: python -m performance_comparison.run_benchmark <filename> <algorithm>      # filename of test data in /test_data/")
