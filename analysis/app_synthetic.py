...
Usage:
    python analysis/app_synthetic.py                        # reads <repo-root>/results
    python analysis/app_synthetic.py results_calibration     # reads a different folder
    python analysis/app_synthetic.py results -o out.html     # custom output path
